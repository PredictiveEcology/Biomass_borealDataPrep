...
badgePath <- SpaDES.docs::stageFigure("figures/moduleVersionBadge.png")
...
badgePath <- SpaDES.docs::stageFigure("figures/issuesBadge.png")
...
## includeFigure(): a path that works standalone and when staged into a manual
SpaDES.docs::includeFigure("figures/biomassModel_logBtest.png")
```
...
## includeFigure(): a path that works standalone and when staged into a manual
SpaDES.docs::includeFigure("figures/simulatedB_logBtest.png")
```
...
sppEquiv2 <- sppEquiv[grepl("Abie|Pice|Pinu_Con", Boreal), .(Latin_full, SCANFI, Boreal)][SCANFI != "Pice_Spp"]
sppEquiv2[grepl("Pice_", SCANFI), Boreal := "Pice_Spp"]
...
caption <- paste("Example of species merging for simulation.",
                 ...
                 "For this, all six species are identified in the 'SCANFI' column,",
