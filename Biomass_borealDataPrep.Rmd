...
pkgResults <- Require(
  c("SpaDES.core", "git2r", "dplyr", "data.table", "kableExtra", "pander", "PredictiveEcology/SpaDES.docs"),
  upgrade = FALSE,
  install = FALSE
)
message(paste(basename(names(pkgResults)), pkgResults, sep = ": ", collapse = "\n"))

stopifnot(isTRUE(all(pkgResults)))
```

:::{.rmdwarning}
This documentation is work in progress.
Please report any discrepancies or omissions at <https://github.com/PredictiveEcology/Biomass_borealDataPrep/issues>.
:::
...
SpaDES.docs::panble(sppEquiv2, caption, 
                    ...
                    column_specArgs = list("column" = which(names(sppEquiv2) %in% c("Species", "Modelled as")),
                                           "italic" = TRUE),
                    kable_stylingArgs = list(full_width = FALSE))
```
