...
study area used to derive parameters (`studyArea_biomassParam`) and the study area where
...
identical, `studyArea` must be fully within `studyArea_biomassParam`. If
`studyArea_biomassParam` and `studyArea` are in Canada, the module can automatically
...
layer versions `studyArea_biomassParam` and `studyArea` (`rasterToMatch_biomassParam` and
