defineModule(sim, list(
  ...
  version = list(Biomass_borealDataPrep = "1.6.4"),
  ...
  parameters = rbind(
    ...
    defineParameter("subsetDataAgeModel", "numeric", LandR::subsetDataSize(), NA, NA,
                    paste("the number of samples per group to use when subsampling the age data model and when",
                          "fitting `coverPctToBiomassPctModel`. Can be `TRUE`/`FALSE`/`NULL` or numeric; if",
